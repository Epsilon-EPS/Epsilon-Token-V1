...
contract EPSTrack is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("EPS_Track", "EPS_Track") {
        claimWait = 300;
    ...
    function _transfer(
        ...
        require(false, "EPS_Track: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        ...
        require(
            ...
            "EPS_Track: Cannot update claimWait to same value"
        );
